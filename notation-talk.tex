...
\bi
\item Discrete random variable -- takes discrete values (e.g.~1, 2, 3, ...)
\item Continuous random variable -- can take any value within a specified range
  (e.g.~between 0 and 10).
\ei

$f(x)$ -- \emph{probability mass function} of a discrete variable $X$

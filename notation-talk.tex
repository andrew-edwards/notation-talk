...
\pause As written it does not any information as written, since the \red{letters are not
defined}.
...
Imperative to give the equation \red{\emph{and the definitions}} of its terms:
\eb
S = cA^z,
\label{spAcurve}
\ee
